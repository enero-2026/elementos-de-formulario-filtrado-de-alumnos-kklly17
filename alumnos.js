...
import { List, TextInput, Text, IconButton, View } from 'react-native-paper';
  ...
  return (
    <>
      <TextInput
        label="Buscar alumno..."
        value={buscarAlumno}
        onChangeText={(alumno) => setBuscarAlumno(alumno)}
      />

      <IconButton
        icon={ordenamiento === 'asc' ? 'sort-alphabetical-ascending' : 'sort-alphabetical-descending'}
        size={28}
        onPress={toggleOrden}
      />

      <FlatList
        data={alumnosOrdenados}z
